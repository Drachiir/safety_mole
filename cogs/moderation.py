...
def get_guild_icon_url(interaction: discord.Interaction) -> str:
    """Returns the guild icon URL or a fallback default avatar URL if None."""
    return interaction.guild.icon.url if interaction.guild.icon else "https://cdn.legiontd2.com/icons/DefaultAvatar.png"
...
class Moderation(commands.Cog):
    ...
    async def ban(self, interaction: discord.Interaction, user: discord.User, reason: str, delete_message_days: typing.Literal['1day', '3days', '5days', '7days']="7days"):
        ...
        embed2.set_author(name=f"{interaction.guild.name} Discord Server", icon_url=get_guild_icon_url(interaction))
        try:
